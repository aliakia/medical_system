...
@section('content')
    <section id="basic-datatable">
        ...
        {{-- add user modal --}}
        <div class="modal modal-slide-in new-user-modal fade text-left" id="add_user_modal" tabindex="-2" role="dialog"
            aria-labelledby="myModalLabel2" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                        ...
                        <form action="" method="POST" id="reg_form" class="mt-1">
                            <div class="col-12">
                                <div class="w-100 mb-1 px-auto">
                                    <img src="{{ asset('images/default.png') }}" id="picture_1"
                                        class="bg-secondary mx-auto col-12" alt="default.png" height="75%"
                                        width="75%" />
                                </div>
                                <label id="select" class="btn btn-secondary mb-1 w-100" data-toggle="modal"
                                    data-target="#camera">Open Camera</label>
                                <input id="base_64" type="hidden" name="base_64" value="" />

                                <div id="no_need_bio">
                                    <button type="button" class="btn btn-secondary mb-1 w-100" id="open_bio">Register
                                        fingerprint</button>
                            ...
                            <div class="hidden physician_form" id="physician_form">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control flatpickr-basic" id="bday"
                                            placeholder="YYYY-MM-DD" name="bday" aria-describedby="bday"
                                            value="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="prc_no" class="form-control" name="prc_no"
                                            placeholder="PRC No." />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="ptr_no" class="form-control" name="ptr_no"
                                            placeholder="PTR No." />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email_address" class="form-control"
                                            name="email_address" placeholder="@" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control flatpickr-basic" id="prc_expiration"
                                            placeholder="YYYY-MM-DD" name="prc_expiration"
                                            aria-describedby="prc_expiration" value="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="physician_id" class="form-control" name="physician_id"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control flatpickr-basic" id="user_expiration"
                                        placeholder="YYYY-MM-DD" name="user_expiration"
                                        aria-describedby="user_expiration" value="" />
                                </div>
                            </div>
                    ...
                    @endif --}}
                                    ...
                                    <div class="input-group input-group-merge form-password-toggle">
                                        <input type="password" class="form-control form-control-merge"
                                            id="confirm_password" name="confirm_password" tabindex="2"
                                            placeholder="Confirm your Password" aria-describedby="conifirm_password" />
                                        <div class="input-group-append">
                                            <span class="input-group-text cursor-pointer"><i
                                                    data-feather="eye"></i></span>
                                        </div>
                            ...
                            <div class="col-12">
                                <button type="button" class="btn btn-success btn-block" tabindex="3"
        ...
        {{-- edit user modal --}}
        <div class="modal modal-slide-in new-user-modal fade text-left" id="edit_user_modal" tabindex="-2"
            role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" data-backdrop="static"
            data-keyboard="false">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content pt-0">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
            ...
            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body">
                        <form action="" method="POST" id="edit_form" class="mt-1">
                            <div class="col-12">
                                <div class="w-100 mb-1 px-auto">
                                    <img src="{{ asset('images/default.png') }}" id="picture_1_edit"
                                        class="bg-secondary mx-auto col-12" alt="default.png" height="75%"
                                        width="75%" />
                                </div>
                                <label id="select2" class="btn btn-secondary mb-1 w-100" data-toggle="modal"
                                    data-target="#camera2">Open Camera</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first_name_edit" class="form-control"
                                        name="first_name_edit" placeholder="First Name"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="middle_name_edit" class="form-control"
                                        name="middle_name_edit" placeholder="Middle Name"
                                        oninput="this.value = this.value.toUpperCase()" />
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="last_name">Last Name</label>
                                    <input type="text" id="last_name_edit" class="form-control" name="last_name_edit"
                                        placeholder="Last Name" oninput="this.value = this.value.toUpperCase()" />
                                </div>
                            </div>
                            ...
                            <div class="hidden physician_edit_form" id="physician_edit_form">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control flatpickr-basic" id="bday_edit"
                                            placeholder="YYYY-MM-DD" name="bday_edit" aria-describedby="bday"
                                            value="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="civil_status_edit" id="civil_status_edit"
                                            class="select2 form-contol hide-search">
                                            <option selected disabled>Select User Type</option>
                                            <option value="Single">Single</option>
                                            <option value="Married">Married</option>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="prc_no_edit" class="form-control" name="prc_no_edit"
                                            placeholder="PRC No." />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="ptr_no_edit" class="form-control" name="ptr_no_edit"
                                            placeholder="PTR No." />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="contact_no_edit" class="form-control"
                                            name="contact_no_edit" placeholder="Contact No." />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email_address_edit" class="form-control"
                                            name="email_address_edit" placeholder="@" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control flatpickr-basic"
                                            id="prc_expiration_edit" placeholder="YYYY-MM-DD" name="prc_expiration_edit"
                                            aria-describedby="prc_expiration" value="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="physician_id_edit" class="form-control"
                                            name="physician_id_edit" placeholder="Phyisician ID" />
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control flatpickr-basic" id="user_expiration_edit"
                                        placeholder="YYYY-MM-DD" name="user_expiration_edit"
                                        aria-describedby="user_expiration" value="" />
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="hidden" id="user_id_edit" class="form-control" name="user_id_edit"
                                        placeholder="User ID" />
                                </div>
                            </div>
