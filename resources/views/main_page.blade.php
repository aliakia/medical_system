...
@section('content')
    <section id="main_page">
        ...
        <div class="row">
                ...
                <div class="row" style="height: 100px;">
                    <div class="col-6" style="height: 100px;">
                        <a href="{{ route('new_trans', Session('data_clinic')->clinic_id) }}" id="btn_new_trans"
                            class="w-100 btn btn-outline-primary justify-center align-items-center" style="height: 100px;">
                            {{-- <i class="ti ti-plus"></i> --}}
                                                        ...
                                                        <ul class="list-unstyled alternating-rows">
                                                            ...
                                                            <li class="row">
                                                                <strong class="col-6">UPPER EXTREMITIES
                                                                    RIGHT:</strong>
                                                                <span class="col-6"
                                                                    id="pv_upperextremities_right"></span>
                                                            </li>
                                                            <li class="row">
                                                                <strong class="col-6">UPPER EXTREMITIES
                                                                    LEFT:</strong>
                                                            ...
                                                            <li class="row">
                                                                <strong class="col-6">LOWER EXTREMITIES
                                                                    RIGHT:</strong>
                                                                <span class="col-6"
                                                                    id="pv_lowerextremities_right"></span>
                                                            </li>
                                                            <li class="row">
                                                                <strong class="col-6">LOWER EXTREMITIES
                                                                    LEFT:</strong>
                                                        ...
                                                        <ul class="list-unstyled alternating-rows">
                                                            ...
                                                            <li class="row">
                                                                <strong class="col-6">WHAT MEDICAL
                                                                    CONDITION:</strong>
                                                                <span class="col-6"
                                                                    id="pv_other_medical_condition"></span>
                                                            </li>
                                                            <li class="row">
                                                    ...
                                                    <span class="col-6"
                                                        id="pv_recno">recno }}</span>
                                                            ...
                                                            <li class="row">
                                                                ...
                                                                <span class="col-6"
                                                                    id="pv_snellen_bailey_lovie_left"></span>
                                                            </li>
                                                            ...
                                                            <li class="row">
                                                                <strong class="col-6">RIGHT EYE:
                                                                    SNELLEN/BAILEY-LOVIE:</strong>
                                                                <span class="col-6"
                                                                    id="pv_snellen_bailey_lovie_right"></span>
                                                                </span>
                                                            </li>
                                                            ...
                                                            <li class="row">
                                                                <strong class="col-6">WITH CORRECTIVE LENS
                                                                    (LEFT):</strong>
                                                                <span class="col-6"
                                                                    id="pv_snellen_with_correct_left"></span>
                                                            </li>
                                                            <li class="row">
                                                                <strong class="col-6">WITH CORRECTIVE LENS
                                                                    (RIGHT):</strong>
                                                                <span class="col-6"
                                                                    id="pv_snellen_with_correct_right"></span>
                                                            </li>
                                                            <li class="row">
                                                    ...
                                                    <ul class="list-unstyled alternating-rows">
                                                        ...
                                                        <li class="row">
                                                            <strong class="col-6">UPPER EXTREMITIES
                                                                RIGHT:</strong>
                                                            <span class="col-6"
                                                                id="pv_upperextremities_right">NORMAL</span>
                                                        </li>
                                                        <li class="row">
                                                            <strong class="col-6">UPPER EXTREMITIES
                                                                LEFT:</strong>
                                                            <span class="col-6"
                                                                id="pv_upperextremities_left">NORMAL</span>
                                                        </li>
                                                        <li class="row">
                                                            <strong class="col-6">LOWER EXTREMITIES
                                                                RIGHT:</strong>
                                                            <span class="col-6"
                                                                id="pv_lowerextremities_right">NORMAL</span>
                                                        </li>
                                                        <li class="row">
                                                            <strong class="col-6">LOWER EXTREMITIES
                                                                LEFT:</strong>
                                                            <span class="col-6"
                                                                id="pv_lowerextremities_left">NORMAL</span>
                                                        </li>
                                                      ...
                                                      id="pv_recno">recno }}</span>
                                                        ...
                                                        <li class="row">
                                                            <strong class="col-6">LEFT EYE:
                                                                SNELLEN/BAILEY-LOVIE:</strong>
                                                            <span class="col-6"
                                                                id="pv_snellen_bailey_lovie_left">1.0</span>
                                                        </li>
                                                        ...
                                                        <li class="row">
                                                            <strong class="col-6">RIGHT EYE:
                                                                SNELLEN/BAILEY-LOVIE:</strong>
                                                            <span class="col-6"
                                                                id="pv_snellen_bailey_lovie_right">1.9</span>
                                                            </span>
                                                        </li>
                                                        ...
                                                        <li class="row">
                                                            <strong class="col-6">WITH CORRECTIVE LENS
                                                                (LEFT):</strong>
                                                            <span class="col-6"
                                                                id="pv_snellen_with_correct_left">NO</span>
                                                        </li>
                                                        <li class="row">
                                                            <strong class="col-6">WITH CORRECTIVE LENS
                                                                (RIGHT):</strong>
                                                            <span class="col-6"
                                                                id="pv_snellen_with_correct_right">NO</span>
                                                        </li>
                                                        <li class="row">
                                                            <strong class="col-6">COLOR BLIND (LEFT):</strong>
            ...
            {{-- <div class="col-12 col-md-12 col-lg-12 visually-hidden">
