...
@section('content')
    <div class="auth-wrapper auth-v2">
        <div class="auth-inner row m-0" style = "background:white;">
            <!-- Brand logo-->
            ...
            <div class="d-none d-lg-flex col-lg-8 align-items-center">
                <div class="w-100 d-lg-flex align-items-center justify-content-center">
                    ...
                    @else
                        <img class="img-fluid w-75" src="{{ asset('images/bg1.jpg') }}" alt="Login V2" />
                    @endif
                </div>
            </div>
            <!-- /Left Text-->
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    ...
                    <form class="auth-login-form mt-2" method="POST"
                        action="{{ route('login_user', Session('data_clinic')->clinic_id) }}" id="login_form">
                        @csrf
                ...
                @endif --}}
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input type="password" class="form-control form-control-merge" id="password"
                                    name="password" tabindex="2" placeholder="Enter your Password" value="12345"
