...
@if (isset($navbarFull))
    <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
        <a href="{{ url('/') }}" class="app-brand-link gap-2">
            ...
            <span class="fw-bold">RBR Medical Clinic</span>
        </a>
    </div>
@endif
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    ...
                    @if (Session('LoggedUser')->pic1 == '' || Session('LoggedUser')->pic1 == null)
                        <img class="h-auto rounded-circle" src="{{ asset('images/default.png') }}" alt="avatar">
                    @else
                        <img class="h-auto rounded-circle" src="{{ Session('LoggedUser')->pic1 }}" alt="avatar">
                    @endif
                </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
