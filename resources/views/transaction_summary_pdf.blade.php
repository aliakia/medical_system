    ...
    <table style="width:90%; margin:auto auto;">
        <tr>
            <th colspan="12" style="text-align:center; width:100%; padding-left:4px;">
                <img
                    src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/images/Medical Raw.jpg'))) }}"
        ...
        <tr style="width:100%;">
            <td colspan="12" style="padding-top: 30px; text-align: left; color:black; font-size:12px; font-weight:bold">Date: {{$date_from}} - {{$date_to}}</td>
        </tr>
