                ...
                <div id="step1" class="content">
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-3 my-2">
                        ...
                        <div class="embed-responsive embed-responsive-1by1 mb-1 bg-slate-900">
                            <img src="{{ asset('images/default.png') }}" id="picture_1" class="bg-secondary w-50"
                                alt="default.png" height="100%" />
                        </div>
                        <button id="select" class="btn btn-primary w-50 w-sm-100" data-toggle="modal"
                            data-target="#camera">
                            Open Camera
                        </button>
