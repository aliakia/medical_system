...
{{-- @section('page-style')
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/css/pages/pickers/form-flat-pickr.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/css/pages/pickers/form-pickadate.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/css/pages/form-wizard.css') }}">
...
@section('content')
    <section id="registration" class="pb-1">
        ...
        <div class="bs-stepper wizard-vertical vertical horizontal-wizard-example px-1">
            ...
            <div class="bs-stepper-header visually-hidden">
            ...
            <div class="bs-stepper-content">
                            ...
                            <div class="col-12 col-md-2">
                                <div class="embed-responsive-1by1">
                                    <img src="{{ asset('images/default.png') }}" id="picture_1" class="bg-secondary"
                                        alt="default.png" height="100%" width="100%" />
                                </div>
                                <label id="select" class="btn btn-primary mb-3 my-25 w-100" data-toggle="modal"
                                    data-target="#camera">Open Camera</label>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="nationality" id="nationality" class="select2 form-contol hide-search">
                                        ...
                                        <option value="GBR">British(United Kingdom of Great Britain and Northern
                                            Ireland)</option>
                                        ...
                                        <option value="DOM">Citizen of the Dominican Republic(Dominican Republic)
                                        </option>
                ...
                <div id="physical_exam" class="content">
                    ...
                    <form class="form form-vertical" id="physical_trans_form" method="POST" action="">
                        @csrf
                        <div class="row mb-25">
                            <div class="content-header col-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" id="body_temperature" class="form-control"
                                                name="body_temperature" placeholder="Body Temperature" />
                                        </div>

                                        <div class="col-6">
                                            <label for="scale_temperature">Scale of Temperature</label>
                                            <input type="text" id="scale_temperature" class="form-control"
                                                name="scale_temperature" value="celcius(°C)" />
                                        </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pulse_rate" class="form-control" name="pulse_rate"
                                    ...
                                    <div class="select">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="disability2" name="disability"
                                                class="custom-control-input" value="WithDisability" />
                                            <label class="custom-control-label mb-1" for="disability2">With Disability,
                                                Pls Specify</label>
                                            <input type="text" id="txtdisability" class="form-control hidden"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="disease1" name="disease"
                                        ...
                                        <div class="custom-control custom-radio mb-2">
                                            ...
                                            <label class="custom-control-label mb-1" for="disease2">With Disease, Pls
                                                Specify</label>
                                            <input type="text" id="txtdisease" class="form-control hidden"
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <button class="btn btn-secondary btn-prev mr-md-25">
                                <i class="ti ti-arrow-left" class="align-middle mr-sm-25 mr-0"></i>
                                <span class="align-middle d-md-inline-block d-none">Previous</span>
                            </button>
                        </div>
                ...
                <div id="visual_hearing_exam" class="content">
                    ...
                    <form class="form form-vertical" id="visual_hearing_trans_form" method="POST" action="">
                        @csrf

                        <div class="row mb-25">

                            <div class="content-header col-12">
                                <h3 class="my-1">Visual and Hearing Test</h3>
                            </div>
                                    ...
                                    <div class="select">
                                        ...
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label mb-1"
                                                for="corrective_lens_left2">No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="corrective_lens_right1"
                                                name="corrective_lens_right" class="custom-control-input"
                                                value="1" />
                                            <label class="custom-control-label" for="corrective_lens_right1">Yes</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="corrective_lens_right2"
                                                name="corrective_lens_right" class="custom-control-input"
                                                value="0" />
                                            <label class="custom-control-label mb-1"
                                                for="corrective_lens_right2">No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="form-group">
                                            <label for="glare_contrast_sensitivity_without_lense_right">Right Eye: Without
                                                Lenses</label>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="form-group">
                                            <label for="glare_contrast_sensitivity_without_lense_left">Left Eye: Without
                                                Lenses</label>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="form-group">
                                            <label for="glare_contrast_sensitivity_with_corrective_right">Right Eye: With
                                                Corrective or Contact Lenses</label>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="form-group">
                                            <label for="glare_contrast_sensitivity_with_corrective_left">Left Eye: With
                                                Corrective or Contact Lenses</label>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="color_blind_test" class="form-control"
                                        name="color_blind_test" placeholder="Color Blind Test" />
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="examination_suggested1"
                                                name="examination_suggested" class="custom-control-input"
                                                value="YES" />
                                            <label class="custom-control-label" for="examination_suggested1">Yes</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="examination_suggested2"
                                                name="examination_suggested" class="custom-control-input" value="NO"
                                                selected />
                                            <label class="custom-control-label mb-1"
                                                for="examination_suggested2">No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    <div class="select">
                                        ...
                                        <select name="hearing_left" id="hearing_left"
                                            class="select2 form-control hide-search">
                                            <option selected disabled>Select-</option>
                                            <option value="1">Normal</option>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    <div class="select">
                                        ...
                                        <select name="hearing_right" id="hearing_right"
                                            class="select2 form-control hide-search">
                                            <option selected disabled>Select-</option>
                                            <option value="1">Normal</option>
                                            <option value="2">Reduced</option>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="">
                            <button class="btn btn-danger mr-md-25" id="cancel_3">
                                <span class="align-middle d-md-inline-block d-none">Cancel</span>
                                <i class="ti ti-x" class="align-middle ml-sm-25 ml-0"></i>
                            </button>
                            <button class="btn btn-success mr-md-25" id="save_3">
                                <span class="align-middle d-md-inline-block d-none">Save</span>
                                <i class="ti ti-device-floppy" class="align-middle ml-sm-25 ml-0"></i>
                            </button>
                            <button class="btn btn-primary" id="next_3">
                                <span class="align-middle d-md-inline-block d-none">Next</span>
                                <i class="ti ti-arrow-right" class="align-middle ml-sm-25 ml-0"></i>
                            </button>
                        </div>
                ...
                <div id="metabolic_neurological_exam" class="content">
                    ...
                    <form class="form form-vertical" id="metabolic_neurological_exam_form" method="POST"
                        action="">
                        @csrf
                        <div class="row mb-25">
                            <div class="content-header col-12">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="epilepsy1" name="epilepsy"
                                                class="custom-control-input" value="1" />
                                            <label class="custom-control-label" for="epilepsy1">Yes</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="epilepsy2" name="epilepsy"
                                                class="custom-control-input" value="0" />
                                        ...
                                        <div class="select">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="epilepsy_treatment1" name="epilepsy_treatment"
                                                    class="custom-control-input" value="1" />
                                                <label class="custom-control-label" for="epilepsy_treatment1">Yes, Pls
                                                    Specify</label>
                                                <input type="text" id="txt_epilepsy_treatment" class="form-control"
                                                    name="txt_epilepsy_treatment" placeholder="..." />
                                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <div id="div_last_seizure" class="hidden">
                                        ...
                                        <input type="text" id="last_seizure" class="form-control"
                                            name="last_seizure" placeholder="last_seizure" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="diabetes1" name="diabetes"
                                                class="custom-control-input" value="1" />
                                            <label class="custom-control-label" for="diabetes1">Yes</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="diabetes2" name="diabetes"
                                                class="custom-control-input" value="0" />
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <div class="hidden" id="div_diabetes_treatment">
                                        ...
                                        <div class="select">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="diabetes_treatment1"
                                                    name="diabetes_treatment" class="custom-control-input"
                                                    value="1" />
                                                <label class="custom-control-label" for="diabetes_treatment1">Yes, Pls
                                                    Specify</label>
                                                <input type="text" id="txt_diabetes_treatment" class="form-control"
                                                    name="txt_diabetes_treatment" placeholder="..." />
                                            </div>

                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="diabetes_treatment2"
                                                    name="diabetes_treatment" class="custom-control-input"
                                                    value="0" />
                                                <label class="custom-control-label mb-1"
                                                    for="diabetes_treatment2">No</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="select">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="sleepapnea_treatment1"
                                                    name="sleepapnea_treatment" class="custom-control-input"
                                                    value="1" />
                                                <label class="custom-control-label" for="sleepapnea_treatment1">Yes, Pls
                                                    Specify</label>
                                                <input type="text" id="txt_sleepapnea_treatment"
                                                    class="form-control" name="txt_sleepapnea_treatment"
                                                    placeholder="..." />
                                            </div>
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="sleepapnea_treatment2"
                                                    ...
                                                    value="0" />
                                                <label class="custom-control-label mb-1"
                                                    for="sleepapnea_treatment2">No</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="select">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="mental1" name="mental"
                                                class="custom-control-input" value="1" />
                                            <label class="custom-control-label" for="mental1">Yes</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="mental2" name="mental"
                                                class="custom-control-input" value="0" />
                                        ...
                                        <div class="select">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="mental_treatment1" name="mental_treatment"
                                                    class="custom-control-input" value="1" />
                                                <label class="custom-control-label" for="mental_treatment1">Yes, Pls
                                                    Specify</label>
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="mental_treatment2" name="mental_treatment"
                                                    class="custom-control-input" value="0" />
                                                <label class="custom-control-label mb-1"
                                                    for="mental_treatment2">No</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="other1" name="other"
                                            class="custom-control-input" value="1" />
                                        <label class="custom-control-label mb-1" for="other1">Yes, Pls
                                            Specify:</label>
                                        <input type="text" id="other_medical_condition" class="form-control hidden"
                                            name="other_medical_condition" placeholder="Specify other condition" />
                                    </div>
                                        ...
                                        <div class="select">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="other_treatment1" name="other_treatment"
                                                    class="custom-control-input" value="1" />
                                                <label class="custom-control-label" for="other_treatment1">Yes, Pls
                                                    Specify</label>
                                                <input type="text" id="txt_other_treatment" class="form-control"
                                                    name="txt_other_treatment" placeholder="..." />
                                            </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="">
                                <button class="btn btn-danger mr-md-25" id="cancel_4">
                                    <span class="align-middle d-md-inline-block d-none">Cancel</span>
                                    <i class="ti ti-x" class="align-middle ml-sm-25 ml-0"></i>
                                </button>
                                <button class="btn btn-success mr-md-25" id="save_4">
                                    <span class="align-middle d-md-inline-block d-none">Save</span>
                                    <i class="ti ti-device-floppy" class="align-middle ml-sm-25 ml-0"></i>
                                </button>
                                <button class="btn btn-primary" id="next_4">
                                    <span class="align-middle d-md-inline-block d-none">Next</span>
                                    <i class="ti ti-arrow-right" class="align-middle ml-sm-25 ml-0"></i>
                                </button>
                            </div>
                ...
                <div id="assessment_condition" class="content">
                    ...
                    <form class="form form-vertical" id="assessment_condition_form" method="POST" action="">
                        @csrf
                        <div class="row mb-25">
                            <div class="content-header col-12">
                                                ...
                                                <div class="select hidden" id="div_assessment_status">
                                                    ...
                                                    <div class="custom-control custom-radio mb-25">
                                                        <input type="radio" id="assessment_status1"
                                                            name="assessment_status" class="custom-control-input"
                                                            value="Permanent" />
                                                    ...
                                                    <div class="custom-control custom-radio mb-25">
                                                        <input type="radio" id="assessment_status2"
                                                            ...
                                                            value="Temporary" />
                                                        <label class="custom-control-label"
                                                            for="assessment_status2">Temporary, Pls Specify
                                                            Duration</label>
                                                    ...
                                                    <div class="custom-control custom-radio mb-25">
                                                        <input type="radio" id="assessment_status3"
                                                            ...
                                                            value="Refer" />
                                                        <label class="custom-control-label"
                                                            for="assessment_status3">Refer to Specialist for further
                                                            evalution</label>
                                                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group" id="div_condition">
                                    ...
                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input conditions"
                                            id="conditions1" name="conditions" value="0" />
                                        <label class="custom-control-label" for="conditions1">None</label>
                                    </div>

                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input conditions"
                                            id="conditions2" name="conditions" value="1" />
                                        <label class="custom-control-label" for="conditions2">Drive only with corrective
                                            lens</label>
                                    </div>

                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input conditions"
                                            id="conditions3" name="conditions" value="2" />
                                        <label class="custom-control-label" for="conditions3">Drive only with special
                                            equipment for upper limbs</label>
                                    </div>

                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input conditions"
                                            id="conditions4" name="conditions" value="3" />
                                        <label class="custom-control-label" for="conditions4">Drive only with special
                                            equipment for lower limbs</label>
                                    </div>

                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input conditions"
                                            id="conditions5" name="conditions" value="4" />
                                        <label class="custom-control-label" for="conditions5">Drive only during
                                            daylight</label>
                                    </div>

                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input conditions"
                                            id="conditions6" name="conditions" value="5" />
                                        <label class="custom-control-label" for="conditions6">Drive only with hearing
                                            aid</label>
                                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="">
                            <button class="btn btn-danger mr-md-25" id="cancel_6">
                                <span class="align-middle d-md-inline-block d-none">Cancel</span>
                                <i class="ti ti-x" class="align-middle ml-sm-25 ml-0"></i>
                            </button>
                            <button class="btn btn-success mr-md-25" id="save_6">
                                <span class="align-middle d-md-inline-block d-none">Save</span>
                                <i class="ti ti-device-floppy" class="align-middle ml-sm-25 ml-0"></i>
                            </button>
                            <button class="btn btn-primary" id="next_6">
                                <span class="align-middle d-md-inline-block d-none">Next</span>
                                <i class="ti ti-arrow-right" class="align-middle ml-sm-25 ml-0"></i>
                            </button>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="">
                            <b>Look at the pictures below, and identify the number that you see in the corresponding
                                boxes.</b>
                        ...
                        <div class="row p-1 d-flex justify-content-center">
                            ...
                            <div class="col-12 col-lg-5 col-md-5 col-xl-5 p-1 m-1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6 col-md-6 col-xl-6">
                                        <button type="button"
                                            class="btn btn btn-outline-success col-12 text-center mb-50"
