...
@section('content')
    <div class="col-sm-12 mb-4">
        ...
        <div id="wizard-validation" class="bs-stepper horizontal-wizard-example mt-2">
            ...
            <input type="hidden" name="data_test_physical_completed" id="data_test_physical_completed"
                value="{{ $test_physical_completed }}">
            <input type="hidden" name="data_test_visual_actuity_completed" id="data_test_visual_actuity_completed"
                value="{{ $test_visual_actuity_completed }}">
            <input type="hidden" name="data_test_hearing_auditory_completed" id="data_test_hearing_auditory_completed"
                value="{{ $test_hearing_auditory_completed }}">
            <input type="hidden" name="data_test_metabolic_neurological_completed"
                id="data_test_metabolic_neurological_completed" value="{{ $test_metabolic_neurological_completed }}">
            <input type="hidden" name="data_test_health_history_completed" id="data_test_health_history_completed"
                value="{{ $test_health_history_completed }}">
            <input type="hidden" name="data_is_final" id="data_is_final" value="{{ $is_final }}">
            <input type="hidden" name="data_is_ltms_uploaded" id="data_is_ltms_uploaded"
                value="{{ $is_ltms_uploaded }}">
            ...
            <div class="bs-stepper-content">
                <div id="step1" class="content">
                    ...
                    <form id="saveTransForm" method="POST" action="" onSubmit="return false">
                        @csrf
                ...
                <div id="step2" class="content">
                    ...
                    <form id="save_physical_trans_form" method="POST" action="" onSubmit="return false">
                        @csrf
                        <div class="row g-3 mb-2">
                            {{-- <div class="col-sm-12 col-xl-3">
                ...
                <div id="step3" class="content">
                    ...
                    <form id="save_visual_hearing_trans_form" method="POST" action="" onSubmit="return false">
                        <div class="row g-3 mb-2">
                ...
                <div id="step4" class="content">
                    ...
                    <form id="save_metabolic_neurological_exam_form" method="POST" action=""
                ...
                <div id="step5" class="content">
                    ...
                    <form id="save_assessment_condition_form" method="POST" action="" onSubmit="return false">
                        <div class="row g-3 mb-2">
                                ...
                                <div class="form-group mt-1">
                                    <div class="select visually-hidden" id="div_assessment_status">
                                        ...
                                        <div class="custom-control custom-radio mb-25">
                                            <input type="radio" id="assessment_status1" name="assessment_status"
                                                class="form-check-input" value="Permanent" />
                                            <label class="form-label" for="assessment_status1">Permanent</label>
                                        </div>
                                        ...
                                        <div class="custom-control custom-radio mb-25">
                                            <input type="radio" id="assessment_status3" name="assessment_status"
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="visually-hidden" id="div_condition">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-label" for="conditions2">Drive only
                                            with corrective lens</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input conditions" id="conditions3"
                                            name="conditions" value="2" />
                                        <label class="form-label" for="conditions3">Drive only
                                            with special equipment for upper limbs</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input conditions" id="conditions4"
                                            name="conditions" value="3" />
                                        <label class="form-label" for="conditions4">Drive only
                                            with special equipment for lower limbs</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input conditions" id="conditions5"
                                            name="conditions" value="4" />
                                        <label class="form-label" for="conditions5">Drive only
                                            during daylight</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input conditions" id="conditions6"
                                            name="conditions" value="5" />
                                        <label class="form-label" for="conditions6">Drive only
                                            with hearing aid</label>
                                    </div>
                                </div>
                            </div>
