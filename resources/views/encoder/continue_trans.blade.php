...
@section('content')
    <div class="col-sm-12 mb-4">
        <h3 class="text-light fw-semibold">Continue Transaction</h3>
            ...
            <div class="bs-stepper-content">
                        ...
                        <div class="row g-3 mb-2">
                            ...
                            <div class="col-sm-12 col-xl-3">
                                ...
                                <select name="nationality" id="nationality" class="select2 form-contol hide-search">
                                    ...
                                    <option value="R">Norwegian(Norway)</option>
                ...
                <div id="step3" class="content">
                    <div class="row">
                        ...
                        <h6 class="fw-normal mb-1" id="color_blind_result"></h6>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                ...
                                <ul class="list-unstyled alternating-rows">
                                    ...
                                    <li class="row">
                                        <strong class="col-6">LICENSE :</strong>
                            ...
                            <div class="col-12 col-lg-4 d-flex align-items-center justify-content-end p-2">
                                <img src="{{ asset('images/default.png') }}" alt="User Image"
                                    class="img-fluid shadow w-100 border" id="picture_2" />
                            </div>
