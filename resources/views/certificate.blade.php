...
<body style="background:white; font-family:sans-serif; width: 100%; margin: 20px 0px;">
    ...
    /> -->
        <table style="width: 88.235294117647%; margin: auto auto;">
            ...
            <tr style="width:100%">
                <th colspan="3" style="text-align:center; width:100%; ">
                    <img src="{{ asset('images/dotr.png') }}" style="" alt="default.png" height=""
                        width="30%" style="display:block" />

                </th>
                <th colspan="7"
                    style="vertical-align:bottom; width:100%; font-size:13px; font-weight:700; color:black;">
                    MEDICAL CERTIFICATE<br><b style="font-size:13px; font-weight:800; color:black;">DERMALOG REFERENCE
                        NO: {{ $item->trans_no }}</b>
                </th>

                <th colspan="3" style="text-align:center; width:100%;">
                    <img src="{{ asset('images/Land_Transportation_Office.png') }}" style="" alt="default.png"
                        height="" width="30%" />
                </th>
        ...
        <table
            style="width: 88.235294117647%; margin:auto auto; border:1px solid black; border-collapse: separate; border-spacing: 8px 0px;">
            <tr style="width:100%;">
            ...
            <tr style="width:100%;">
                <td colspan="2"
                    style="vertical-align: bottom; text-align: left; color:black; font-size:11px; height: 10px;">NAME:
                </td>
                <td colspan="5"
                    style="vertical-align: bottom; text-align: center; color:black; font-size:11px; border-bottom:1px solid black;">
                    {{ $item->last_name }}</td>
                <td colspan="5"
                    style="vertical-align: bottom; text-align: center; color:black; font-size:11px; border-bottom:1px solid black;">
                    {{ $item->first_name }}</td>
                ...
                <td colspan="4" rowspan="6" style="border: 1px solid black; padding: auto;">
                    @if ($item->id_picture == '' || $item->id_picture == null)
                        <img src="default.png" alt="{{ asset('images/default.png') }}"
                            style="width:100%; height:auto; display: block;" />
                    @else
                        <img src="{{ $item->id_picture }}" alt="default.png"
                            style="width:100%; height:auto; display: block;" />
                    @endif
            ...
            <tr style="width:100%;">
                <td colspan="2"
                    style="vertical-align: bottom; text-align: left; color:black; font-size:11px; height: 10px;">
                    ADDRESS:</td>
            ...
            <tr style="width:100%;">
                <td colspan="5"
                    style="vertical-align: bottom; text-align: left; color:black; font-size:11px; height: 10px;">
                    DRIVERS LINCENSE NUMBER:</td>
                <td colspan="5" style="vertical-align: bottom; text-align: center; color:black; font-size:11px;">
                    <div style=" border-bottom: 1px solid black; position: relative; left: -5px;">
                        {{ $item->license_no }}
                    </div>
                </td>
                <td colspan="3" style="vertical-align: bottom; text-align: right; color:black; font-size:11px;">
                    DATE OF BIRTH:</td>
            ...
            <tr style="width:100%;">
                ...
                <td colspan="1" style="vertical-align: bottom; text-align: center; color:black; font-size:11px;">
                    AGE:</td>
                <td colspan="1"
                    style="vertical-align: bottom; text-align: center; color:black; font-size:11px; margin-right:1px">
                    <div style=" border-bottom: 1px solid black; position: relative; left: -5px;">
                        {{ $item->age }}
                    </div>
                </td>
                ...
                <td colspan="4" style="vertical-align: bottom; text-align: left; color:black; font-size:11px;">
                    MARTIAL STATUS:</td>
                <td colspan="2" style="vertical-align: bottom; text-align: center; color:black; font-size:11px;">
        ...
        <table
            style="width: 88.235294117647%; margin:auto auto; margin-top: 5px; border:1px solid black; border-collapse: separate; border-spacing: 8px 0px;">
            <tr style="width:100%;">
                <th style="width: 5%;padding-top: 5px;"></th>
                <th style="width: 5%;padding-top: 5px;"></th>
                <th style="width: 5%;padding-top: 5px;"></th>
            ...
            <tr style="width:100%;">
                <td colspan="8"
                    style="padding-top: 5px; text-align: left; color:black; font-size:11px; font-weight:bold;">GENERAL
                    PHYSIQUE</td>
                <td colspan="8"
                    style="padding-top: 5px; text-align: left; color:black; font-size:11px; font-weight:bold;">
                    CONTAGIOUS DISEASE</td>
                <td colspan="4"
                    style="padding-top: 5px; text-align: center; color:black; font-size:11px; font-weight:bold;">BLOOD
                    PRESSURE</td>
            </tr>
                ...
                <td colspan="8" style="vertical-align:middle; text-align:left; color:black; padding: 0px;">
                    <div style="display: flex;">
                        @if ($item->pt_general_physique == 'normal')
                            <img src="{{ asset('images/checked-checkbox.png') }}" alt="checkbox_icon"
                                style="position: relative; top: 2px; width:auto; height: 20px; padding: 0px;" />
                        @else
                            <img src="{{ asset('images/unchecked-checkbox.png') }}" alt="checkbox_icon"
                                style="position: relative; top: 2px; width:auto; height: 20px; padding: 0px;" />
                        @endif
            ...
            <tr style="width:100%;">
                ...
                <td colspan="4" style="text-align: center; color:black; font-size:11px; font-weight:bold;">BLOOD
                    TYPE</td>
            </tr>
            ...
            <tr style="width:100%;">
                <td colspan="6"
                    style="padding-top: 3px; text-align: left; color:black; font-size:11px; font-weight:bold">UPPER
                    EXTREMITES:</td>

                <td colspan="10" style="text-align: left; color:black; font-size:11px; font-weight:bold">LOWER
                    EXTREMITES:</td>

                <td colspan="4" style="text-align: center; color:black; font-size:11px; font-weight:bold">EYE COLOR
                </td>
            </tr>
        ...
        <table
            style="width: 88.235294117647%; margin:auto auto; padding-top: 3px; border-collapse: separate; border-spacing: 0px 0px;">
            <tr style="width:100%;">
            ...
            <tr style="width: 100%; page-break-inside: auto;">
                <td colspan="6" style="vertical-align: top; padding:0px; padding-right: 5px;">
                    <table
                        style="width: 100%; margin:0px; border:1px solid black; border-collapse: separate; border-spacing: 8px 0px;">
                        <tr style="width:100%;">
                            <th style="width: 5%;padding-top: 5px;"></th>
                            <th style="width: 5%;padding-top: 5px;"></th>
                            <th style="width: 5%;padding-top: 5px;"></th>
                        ...
                        <tr style="width:100%">
                            <th colspan="20"
                                style="border:1px solid black; text-align:center; width:90%; padding:1px 8px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="11"
                                style="padding-top: 5px; text-align: left; color:black; font-size:11px; font-weight:bold;">
                                LEFT EYE: SNELLEN/BAILEY-LOVIE</td>
                            <td colspan="8"
                                style="vertical-align: bottom; text-align: center; color:black; font-size:11px;">
                                <div style=" border-bottom: 1px solid black; position: relative; left: -21px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="20"
                                style="vertical-align:middle; text-align:left; color:black; padding: 0px;">
                                <div style="display: flex;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="11"
                                style="padding-top: 5px; text-align: left; color:black; font-size:11px; font-weight:bold;">
                                RIGHT EYE: SNELLEN/BAILEY-LOVIE</td>
                            <td colspan="8"
                                style="vertical-align: bottom; text-align: center; color:black; font-size:11px;">
                                <div style=" border-bottom: 1px solid black; position: relative; left: -21px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="12"
                                style="padding-top: 5px; text-align: left; color:black; font-size:11px; font-weight:bold;">
                                Glare/Contrast Sensitivity Function</td>
                            <td colspan="4"
                                style="padding-top: 5px; text-align: center; color:black; font-size:10px; font-weight:bold;">
                                RIGHT EYE</td>
                            <td colspan="4"
                                style="padding-top: 5px; text-align: center; color:black; font-size:10px; font-weight:bold;">
                                LEFT EYE</td>
                        ...
                        <tr>
                            <td colspan="12"
                                style="padding-top: 5px; text-align: left; color:black; font-size:10px;">Without Lenses
                            </td>
                        ...
                        <tr>
                            <td colspan="12"
                                style="padding-top: 5px; text-align: middle; color:black; font-size:10px;">Without
                                Corrective or Contact Lenses</td>
                        ...
                        <tr>
                            <td colspan="4"
                                style="padding-top: 5px; text-align: middle; color:black; font-size:11px;font-weight:bold;">
                                Color Blind:</td>
                        ...
                        <tr>
                            <td colspan="12"
                                style="padding-top: 5px; text-align: middle; color:black; font-size:10px;">ANY EYE
                                INJURY OR DISEASE? (Specify)</td>
                        </tr>

                        <tr>
                            <td colspan="12"
                                style="vertical-align: bottom; text-align: left; color:black; font-size:10px;">
                                <div style=" border-bottom: 1px solid black; position: relative; ">
                        ...
                        <tr>
                            <td colspan="14"
                                style="padding-top: 5px; text-align: middle; color:black; font-size:10px;">IS FURTHER
                                EYE EXAMINATION SUGGESTED?</td>
                        </tr>
                    ...
                    <table
                        style="width: 100%; margin:0px; margin-top: 5px; border:1px solid black; border-collapse: separate; border-spacing: 8px 0px;">
                        <tr style="width:100%;">
                            <th style="width: 5%;padding-top: 5px;"></th>
                            <th style="width: 5%;padding-top: 5px;"></th>
                            <th style="width: 5%;padding-top: 5px;"></th>
                        ...
                        <tr style="width:100%">
                            <th colspan="20"
                                style="border:1px solid black; text-align:center; width:90%; padding:1px 8px;">
                                <b style="font-size: 12px; font-weight:bold; color:black;">METABOLIC AND NEUROLOGICAL
                                    DISORDERS</b>
                            </th>
                        </tr>
                        ...
                        <tr style="width:100%;">
                            <td colspan="3"
                                style="padding-top: 3px; vertical-align:bottom; text-align:left; color:black;">
                                <div style="display: flex;">
                                    @if ($item->mn_diabetes == '1')
                                        <img src="{{ asset('images/checked-checkbox.png') }}" alt="checkbox_icon"
                                            style="position: relative; top: 2px; width:auto; height: 20px;" />
                                    @else
                                        <img src="{{ asset('images/unchecked-checkbox.png') }}" alt="checkbox_icon"
                                            style="position: relative; top: 2px; width:auto; height: 20px;" />
                                    @endif
                        ...
                        <tr style="width:100%;">
                            ...
                            <td colspan="9"
                                style="padding-top: 0px; text-align: left; color:black; font-size: 9px; font-weight:normal; font-style: italic;">
                        ...
                        <tr style="width:100%;">
                            ...
                            <td colspan="15"
                                style="padding-top: 0px; text-align: right; color:black; font-size: 9px; font-weight:normal;">

                            </td>
                            <td colspan="5"
                                style="padding-top: 0px; text-align: center; color:black; font-size: 9px; font-weight:normal;">
                                (Specify)
                            </td>
                        ...
                        <tr style="width:100%;">
                            ...
                            <td colspan="3"
                                style="padding-top: 3px; vertical-align:middle; text-align:left; color:black;">
                                <div style="display: flex;">
                            ...
                            <td colspan="4"
                                ...
                                EPILEPSY</td>
                            <td colspan="5"
                                style="padding-top: 5px; text-align: left; color:black; font-size: 9px; font-weight:normal; font-style: italic;">
                                Date of last seizure
                            </td>
                            <td colspan="5"
                                style="vertical-align: middle; text-align: center; color:black; font-size:11px;">
                        ...
                        <tr style="width:100%;">
                            ...
                            <td colspan="9"
                                style="text-align: left; color:black; font-size: 9px; font-weight:normal; font-style: italic;">
                                is it under proper control or medication?
                            </td>
                            <td colspan="3" style="vertical-align:middle; text-align:left; color:black;">
                                <div style="display: flex;">
                        ...
                        <tr style="width:100%;">
                            ...
                            <td colspan="14"
                                style="padding-top: 5px; text-align: left; color:black; font-size:11px; font-weight:bold;">
                                AGGRESSIVE, MANIC OR DEPRESSIVE ORDER</td>
                        </tr>
                        ...
                        <tr style="width:100%;">
                            <td colspan="14"
                                style="vertical-align: bottom; text-align: justify; text-justify:inter-word; color:black; font-size:11px; border-bottom: 1px solid black;">
                                @if ($item->mn_others == '1')
                    ...
                    <table style="width: 100%; margin:0px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="4"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">PHYSICIAN</td>
                            <td colspan="16"
                                style="vertical-align: middle; text-align: center; color:black; font-size:11px;">
                                <div style=" border-bottom: 1px solid black; position: relative; left: -19px;">
                                    {{ $physician_name }}
                        ...
                        <tr style="width:100%;">
                            <td colspan="7"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">PRC LICENSE
                                NUMBER</td>
                            <td colspan="13"
                                style="vertical-align: middle; text-align: center; color:black; font-size:11px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="5"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">PTR NUMBER
                            </td>
                            <td colspan="15"
                                style="vertical-align: middle; text-align: center; color:black; font-size:11px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="4"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">ISSUED AT</td>
                            <td colspan="16"
                                style="vertical-align: middle; text-align: center; color:black; font-size:11px;">
                                <div style=" border-bottom: 1px solid black; position: relative; left: -19px;">
                                    {{ $clinic_name }}
                        ...
                        <tr style="width:100%;">
                            <td colspan="5"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">CERTIFICATE #
                            </td>
                            <td colspan="16"
                                style="vertical-align: middle; text-align: center; color:black; font-size:11px;">
                                <div style=" border-bottom: 1px solid black; position: relative; left: -19px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="5"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">SIGNATURE</td>
                            <td colspan="16"
                ...
                <td colspan="4" style="vertical-align: top; padding:0px;">
                    <table
                        ...
                        <tr style="width:100%;">
                            <td colspan="10"
                                ...
                                LEFT EAR:</td>
                            <td colspan="10"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold">RIGHT EAR:</td>
                        </tr>

                        <tr style="width:100%;">
                            <td colspan="10"
                                style="vertical-align:middle; text-align:left; color:black; padding-top: 5px;">
                                <div style="display: flex;">
                                ...
                                <div style="display: flex;">
                                    @if ($item->at_hearing_right == '3')
                                        <img src="{{ asset('images/checked-checkbox.png') }}" alt="checkbox_icon"
                                            style="position: relative; top: 2px; width:auto; height: 20px;" />
                                    @else
                                        <img src="{{ asset('images/unchecked-checkbox.png') }}"
                                            alt="checkbox_icon"
                                            style="position: relative; top: 2px; width:auto; height: 20px;" />
                                    @endif
                    ...
                    <table
                        ...
                        <tr style="width:100%;">
                            <td colspan="20"
                                style="vertical-align:middle; text-align:left; color:black; padding: 5px 0px 0px 0px">
                                <div style="display: flex;">
                        ...
                        <tr style="width:100%;">
                            ...
                            <td colspan="18"
                                ...
                                <div style="display: flex;">
                                    ...
                                    @endif
                                    <div
                                        style="font-size:11px; display:inline-block; position: relative; bottom: 2px">
                                        Refer to Specialist for further Evaluation</div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr style="width:100%;">
                            <td colspan="20"
                                style="vertical-align:middle; text-align:left; color:black; padding: 18px 0px 0px 0px;">
                                <div style="display: flex;">
                                    ...
                                    @endif
                                    <div
                                        style="font-size:10px; display:inline-block; position: relative; bottom: 2px;">
                                        None</div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr style="width:100%;">
                            <td colspan="2"
                                style="vertical-align:top; text-align:left; color:black; padding: 0px;">
                            ...
                            <td colspan="18"
                                style="vertical-align:middle; text-align:left; color:black; padding: 5px 0px 0px 0px">
                                <div
                                    style="font-size:10px; display:flex; position: relative; bottom: 2px; padding: 0px;">
                                    Drive only with special equipment for Upper limbs/Lower Limbs</div>
                            </td>
                        </tr>
                        ...
                        <tr style="width:100%;">
                            ...
                            <td colspan="18"
                                style="vertical-align:middle; text-align:left; color:black; padding: 5px 0px 0px 0px">
                                <div
                                    style="font-size:10px; display:flex; position: relative; bottom: 2px; padding: 0px;font-size:10px;">
                                    Drive Customized Motor Vehicle Only</div>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%; margin:0px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="20"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">REMARKS:</td>
                        </tr>
                        <tr style="width:100%;">
                            <td colspan="20"
                                style="vertical-align: top; text-align: justify; text-justify:inter-word; color:black; font-size:9px; height: 32px;">
                                {{ $item->pt_remarks }}
                            </td>
                        </tr>
                        <tr style="width:100%;">
                            <td colspan="6"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">DATE ISSUED:
                            </td>
                            <td colspan="14"
                                style="vertical-align: middle; text-align: center; color:black; font-size:11px;">
                        ...
                        <tr style="width:100%;">
                            <td colspan="20"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">THIS MEDICAL
                                CERTIFICATE IS VALID UNTIL</td>
                        </tr>
                        <tr style="width:100%;">
                            <td colspan="8"
                                style="vertical-align: bottom; text-align: center; color:black; font-size:11px; border-bottom: 1px solid black;">
                            ...
                            <td colspan="12"
                                style="text-align: left; color:black; font-size:11px; font-weight:bold;">(60 DAYS FROM
                                DATE ISSUE)</td>
                        </tr>
                    </table>
                </td>
