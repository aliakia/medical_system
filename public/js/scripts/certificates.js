$(document).ready(function()
{
    ...
    function search() {
        ...
        window.location.href = "get_cert_list,"+_date_from+","+_date_to;
    }
    ...
    $('.print').on('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.open('generate_cert,'+_trans_no+','+_student_id,'_blank');
                $("#loader").removeClass("hidden",function () {
                    $("#loader").fadeIn(500);
                });
                window.location.href = "cert_management";
            } 
    ...
    $('.reprint').on('click', function () {
        ...
        Swal.fire({
            title: "Are you sure?",
            text: 'You want to Reprint this Certificate ?',
            icon: "warning",
            showDenyButton: true,
            confirmButtonText: 'Yes',
            denyButtonText: 'No',
