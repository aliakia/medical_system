        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if (data.status == "1") {
                    ...
                    $('#pv_glare_contrast_sensitivity_without_lense_right').html("<b>"+data.data_scratch[0].vt_glare_contrast_sensitivity_function_without_lenses_right); 
                    $('#pv_glare_contrast_sensitivity_without_lense_left').html("<b>"+data.data_scratch[0].vt_glare_contrast_sensitivity_function_without_lenses_left); 
                    $('#pv_glare_contrast_sensitivity_with_corrective_right').html("<b>"+data.data_scratch[0].vt_glare_contrast_sensitivity_function_with_corretive_lenses_ri); 
                    $('#pv_glare_contrast_sensitivity_with_corrective_left').html("<b>"+data.data_scratch[0].vt_glare_contrast_sensitivity_function_with_corretive_lenses_le);
                   ...
                   if(data.data_scratch[0].mn_other_medical_condition == null || data.data_scratch[0].mn_other_medical_condition == ''){
                ...
                if(data.data_scratch[0].exam_assessment_remarks != '' && data.data_scratch[0].exam_assessment_remarks != null){
                    if(data.data_scratch[0].exam_assessment_remarks == 'Permanent'){
                        ...
                        $('#pv_assessment_status').html("Temporary - "+"Duration: "+data.data_scratch[0].exam_duration_remarks);  
                    }
